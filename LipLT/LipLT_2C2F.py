...
ckpt = torch.load('models/mnist_2C2F_wd.pth','cpu')
...
stride_vec = [(2,2),(2,2),(),()]
padding = (1,1)
input_size_vec = [(1,1,28,28), (1,16,14,14), (1,1568), (1,100)]
...
for kk in range(len(W) - 1):
    ...
    tmp = lipschitz_general(H_list, (1,1,28,28), strides, padding, iter = N)
